...
public class ConstData {
    ...
    public static final String APP_CONTEN_URL = "http://oxj8dd2io.bkt.clouddn.com/BJSCBBWY.text";
    public static final String ABOUT_MESSAGE = "北京赛车开奖查询软件";
    //开奖数据获取
    public static final String LOTTERY_URL = "http://api.jisuapi.com/caipiao/history?appkey=400d09f5f73fbc71&caipiaoid=82&issueno=&start=0&num=20";
    //视频数据获取

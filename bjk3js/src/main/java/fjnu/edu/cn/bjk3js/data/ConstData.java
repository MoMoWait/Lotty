...
public class ConstData {
    ...
    public static final String APP_CONTEN_URL = " http://oxj8dd2io.bkt.clouddn.com/HZJS.text";
    public static final String ABOUT_MESSAGE = "方便的北京快3查询软件";
    //开奖数据获取
    public static final String LOTTERY_URL = "http://api.jisuapi.com/caipiao/history?appkey=400d09f5f73fbc71&caipiaoid=76&issueno=&start=0&num=20";
